...
class ConversationsPage extends React.Component {
    ...
    render() {
        ...
        if(this.state.currentConversation) {
            requestDescription = this.state.conversations.find((con) => con.id == this.state.currentConversation).request.description
        }
        return(
            <Fragment>
                                ...
                                <Paper elevation={2} id='messages-container-header' style={{width: '100%', textAlign: 'center'}} >
                                        {
                                            ...
                                            <Avatar style={{marginRight:'10px'}}>
                                                {this.state.headerContent.match(/\b(\w)/g).join('')}
                                            </Avatar> : null
                                        }
                                ...
                                <Paper elevation={2} id='mobile-messages-container-header' style={{width: '100%', textAlign: 'center'}} onClick={this.toggleDrawer(true)}>
                                        {
                                            this.state.headerContent !== 'Open a conversation' ?
                                            <Avatar style={{marginRight:'10px'}}>
                                                {this.state.headerImage == '' ? this.state.headerContent.match(/\b(\w)/g).join('') : <img src={this.state.headerImage} />}
                                            </Avatar> : null
                                        }
