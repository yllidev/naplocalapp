...
class AccountSettingsPage extends React.Component {
  state = {
    ...
    componentDidMount() {
        if(Cookies.getJSON('currentUser')) {
            var data = Cookies.getJSON('currentUser');
  ...
  render() {
      return(
        <div>
          <Fragment>
              <Navbar title='My Account' history={this.props.history}/>
          </Fragment>
          <form id="sign-up-form" onSubmit={this.handleSubmit} noValidate style={{paddingLeft: '20%', paddingRight: '20%'}}>
            ...
            <div style={{paddingLeft: '20%', paddingRight: '20%', marginTop: '50px' }}>
                <AlertDialog/>
            </div>
        </div>
